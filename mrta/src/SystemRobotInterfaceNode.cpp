 ...
 */
bool mrta_vc::SystemRobotInterfaceNode::finishAllocationCallback(mas_srvs::FinishAllocation::Request& request, mas_srvs::FinishAllocation::Response& response)
{
 ...
 */
void mrta_vc::SystemRobotInterfaceNode::executeCallback(const mas_actions::ExecuteGoal::ConstPtr& goal)
{
