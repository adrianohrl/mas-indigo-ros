 ...
 *
 */
unifei::expertinos::mrta_vc::agents::User::User() : unifei::expertinos::mrta_vc::agents::Person(), computer_(mas_msgs::Agent())
{
}
 ...
 *
 */
unifei::expertinos::mrta_vc::agents::User::User(const mas_msgs::Agent::ConstPtr& user_msg) : unifei::expertinos::mrta_vc::agents::Person(user_msg), computer_(mas_msgs::Agent())
{
 ...
 *
 */
unifei::expertinos::mrta_vc::agents::User::User(mas_msgs::Agent user_msg) : unifei::expertinos::mrta_vc::agents::Person(user_msg), computer_(mas_msgs::Agent())
{
  login_name_ = user_msg.login_name;
	mas_msgs::Agent computer_msg;
	computer_msg.type = COMPUTER;
 ...
 *
 */
mas_msgs::Agent unifei::expertinos::mrta_vc::agents::User::toMsg()
{
	mas_msgs::Agent user_msg = unifei::expertinos::mrta_vc::agents::Person::toMsg();
