 ...
 *
 */
unifei::expertinos::mrta_vc::agents::Person::Person(const mas_msgs::Agent::ConstPtr& person_msg) : unifei::expertinos::mrta_vc::agents::Agent(person_msg)
{
 ...
 *
 */
unifei::expertinos::mrta_vc::agents::Person::Person(mas_msgs::Agent person_msg) : unifei::expertinos::mrta_vc::agents::Agent(person_msg)
{
	name_ = person_msg.name;
	hierarchy_level_ = unifei::expertinos::mrta_vc::agents::HierarchyLevels::toEnumerated(person_msg.hierarchy_level);
}
 ...
 *
 */
mas_msgs::Agent unifei::expertinos::mrta_vc::agents::Person::toMsg() 
{
	mas_msgs::Agent person_msg = unifei::expertinos::mrta_vc::agents::Agent::toMsg();
