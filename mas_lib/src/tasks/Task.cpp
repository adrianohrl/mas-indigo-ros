 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Task::Task() : sender_(mas_msgs::Agent()), receiver_(mas_msgs::Agent())
{
	id_ = 0;
	name_ = "";	
	description_ = "";
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Task::Task(const mas_msgs::Task::ConstPtr& task_msg) : user_(task_msg->user), sender_(task_msg->sender), receiver_(task_msg->receiver)
{
	id_ = task_msg->id;	
	name_ = task_msg->name;
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Task::Task(mas_msgs::Task task_msg) : user_(task_msg.user), sender_(task_msg.sender), receiver_(task_msg.receiver)
{
	id_ = task_msg.id;	
	name_ = task_msg.name;
	description_ = task_msg.description;
 ...
 *
 */
mas_msgs::Task unifei::expertinos::mrta_vc::tasks::Task::toMsg() 
{
