 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Skill::Skill(const mas_msgs::Skill::ConstPtr& skill_msg) : resource_(skill_msg->resource)
{	
  id_ = skill_msg->id;
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Skill::Skill(mas_msgs::Skill skill_msg) : resource_(skill_msg.resource)
{	
  id_ = skill_msg.id;
	level_ = unifei::expertinos::mrta_vc::tasks::SkillLevels::toEnumerated(skill_msg.level);
}
 ...
 *
 */
mas_msgs::Skill unifei::expertinos::mrta_vc::tasks::Skill::toMsg()
{
