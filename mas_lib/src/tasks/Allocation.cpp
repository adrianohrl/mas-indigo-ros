 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Allocation::Allocation(unifei::expertinos::mrta_vc::tasks::Task task, std::vector<unifei::expertinos::mrta_vc::agents::Robot> robots, unifei::expertinos::mrta_vc::tasks::AllocationStateEnum state, unifei::expertinos::mrta_vc::tasks::AllocationSatisfactionEnum satisfaction, ros::Time allocation_timestamp, ros::Time dispatch_timestamp, ros::Time start_timestamp, ros::Time end_timestamp) : task_(task), robots_(robots)
{
	state_ = state;
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Allocation::Allocation(const mas_msgs::Allocation::ConstPtr& allocation_msg) : task_(allocation_msg->task)
{
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::Allocation::Allocation(mas_msgs::Allocation allocation_msg) : task_(allocation_msg.task)
{
	for (int i = 0; i < allocation_msg.robots.size(); i++)
	{
		unifei::expertinos::mrta_vc::agents::Robot robot(allocation_msg.robots.at(i));
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::AllocationSatisfactionEnum unifei::expertinos::mrta_vc::tasks::Allocation::getSatisfaction() 
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::tasks::Allocation::setSatisfaction(unifei::expertinos::mrta_vc::tasks::AllocationSatisfactionEnum satisfaction)
{
	satisfaction_ = satisfaction;
}
 ...
 *
 */
mas_msgs::Allocation unifei::expertinos::mrta_vc::tasks::Allocation::toMsg()
{
	...
	allocation_msg.satisfaction = unifei::expertinos::mrta_vc::tasks::AllocationSatisfactions::toCode(satisfaction_);
...
std::string unifei::expertinos::mrta_vc::tasks::Allocation::toString()
{
	...
	return "allocation: {" + task_.toString() +
			...
			", satisfaction: " + unifei::expertinos::mrta_vc::tasks::AllocationSatisfactions::toString(satisfaction_) +
