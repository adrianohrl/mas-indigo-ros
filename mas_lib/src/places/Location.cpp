 ...
 *
 */
unifei::expertinos::mrta_vc::places::Location::Location(const mas_msgs::Location::ConstPtr& location_msg) 
{
	x_ = location_msg->x;
	y_ = location_msg->y;
 ...
 *
 */
unifei::expertinos::mrta_vc::places::Location::Location(mas_msgs::Location location_msg) 
{
	x_ = location_msg.x;
	y_ = location_msg.y;
	theta_ = location_msg.theta;	
 ...
 *
 */
void unifei::expertinos::mrta_vc::places::Location::setPose(mas_msgs::Location location_msg) 
{
	x_ = location_msg.x;
	y_ = location_msg.y;
	theta_ = location_msg.theta;
 ...
 *
 */
mas_msgs::Location unifei::expertinos::mrta_vc::places::Location::toMsg() 
{
