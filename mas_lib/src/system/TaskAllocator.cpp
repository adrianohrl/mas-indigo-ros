...
#include "unifei/expertinos/mrta_vc/system/TaskAllocator.h"

/**
 *
 */
unifei::expertinos::mrta_vc::system::TaskAllocator::TaskAllocator() 
{	
}
 ...
 *
 */
unifei::expertinos::mrta_vc::tasks::TaskPriorityQueue unifei::expertinos::mrta_vc::system::TaskAllocator::getUnallocatedTasks()
{
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::tasks::Task> unifei::expertinos::mrta_vc::system::TaskAllocator::getAllocatedTasks()
{
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::tasks::Task> unifei::expertinos::mrta_vc::system::TaskAllocator::getRequestedTasks()
{
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::tasks::Allocation> unifei::expertinos::mrta_vc::system::TaskAllocator::getAllocations()
{
	return allocations_;
}
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::agents::Robot> unifei::expertinos::mrta_vc::system::TaskAllocator::getAvailableRobots()
{
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::agents::Robot> unifei::expertinos::mrta_vc::system::TaskAllocator::getBusyRobots()
{
	return busy_robots_;
}
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::agents::Robot> unifei::expertinos::mrta_vc::system::TaskAllocator::getLoggedRobots()
{
 ...
 *
 */
std::list<unifei::expertinos::mrta_vc::agents::User> unifei::expertinos::mrta_vc::system::TaskAllocator::getLoggedUsers()
{
 ...
 *
 */
bool unifei::expertinos::mrta_vc::system::TaskAllocator::areThereAnyAvailableRobots()
{
 ...
 *
 */
bool unifei::expertinos::mrta_vc::system::TaskAllocator::areThereAnyUnallocatedTasks()
{
	return !available_robots_.empty();
}
 ...
 *
 */
bool unifei::expertinos::mrta_vc::system::TaskAllocator::isAvailable(unifei::expertinos::mrta_vc::agents::Robot robot)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::add(unifei::expertinos::mrta_vc::tasks::Allocation allocation)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::add(unifei::expertinos::mrta_vc::tasks::Task task)
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::add(unifei::expertinos::mrta_vc::agents::Robot robot) 
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::add(unifei::expertinos::mrta_vc::agents::User user)
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::remove(unifei::expertinos::mrta_vc::tasks::Task task) 
{
	unallocated_tasks_.push(task);
}
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::remove(unifei::expertinos::mrta_vc::agents::Robot robot) 
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::remove(unifei::expertinos::mrta_vc::agents::User user)
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::updateLoggedRobots() 
{
 ...
 *
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::updateLoggedUsers() 
{
 ...
 *
 */
std::vector<unifei::expertinos::mrta_vc::agents::Robot> unifei::expertinos::mrta_vc::system::TaskAllocator::getBestTeam(unifei::expertinos::mrta_vc::tasks::Task task)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::allocate(unifei::expertinos::mrta_vc::tasks::Task task, std::vector<unifei::expertinos::mrta_vc::agents::Robot> robots)
{
	transfer(task);
	transfer(robots);
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::dispatch(unifei::expertinos::mrta_vc::tasks::Allocation allocation)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::updateUnallocatedTasks()
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::updateAllocations(unifei::expertinos::mrta_vc::tasks::Allocation allocation)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::transfer(unifei::expertinos::mrta_vc::tasks::Task task)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::transfer(unifei::expertinos::mrta_vc::agents::Robot robot)
{
 ...
 */
void unifei::expertinos::mrta_vc::system::TaskAllocator::transfer(std::vector<unifei::expertinos::mrta_vc::agents::Robot> robots)
{
