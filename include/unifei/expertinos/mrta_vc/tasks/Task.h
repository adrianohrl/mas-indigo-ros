	...
	namespace expertinos
	{
		namespace mrta_vc
		{
			namespace tasks
			{
				...
				public:
					Task();
					Task(int id, std::string name, std::string description, std::vector<Skill> desired_tasks, unifei::expertinos::mrta_vc::agents::VoiceCommander sender, unifei::expertinos::mrta_vc::agents::Person receiver, TaskPriorityEnum priority = TaskPriorities::getDefault());
